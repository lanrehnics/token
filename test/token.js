...
describe("Token.sol", () => {
    ...
    describe("Correct setup", () => {
        ...
        it("owner should have all supply", async () => {
    ...
    describe("Core", () => {
        ...
        it("should fail by depositing more than current balance", async () => {
            ...
            let revertedError = contract.transfer(txFailure, aliceAddress);
            await expect(revertedError).to.be.revertedWith("Not enough funds");
        });
